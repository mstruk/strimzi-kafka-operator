...
You may want to try to use a ready-made Docker image based on Fedora with all the tools pre-installed to quickly perform a build. See the instructions [here](DEV_GUIDE-cli-image.md).
